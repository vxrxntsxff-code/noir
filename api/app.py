...
T = {
    ...
    "price_list": (
        ...
        "Форма заявки · SEO · поддержка 1 мес\n\n"
        "<b>БИЗНЕС</b>  ·  59 000 ₽  ⭐️\n"
        "<i>до месяца</i>\n"
        "Сайт до 5 страниц, кастомный дизайн\n"
        "CRM · аналитика · SEO · поддержка 2 мес\n\n"
        "<b>ПРЕМИУМ</b>  ·  112 000 ₽\n"
        "<i>от месяца</i>\n"
        "Сайт 10+ страниц / интернет-магазин\n"
        "UX/UI · CRM · AI-бот · оплата · A/B тесты\n"
        "Поддержка 3 мес\n\n"
        "━━━━━━━━━━━━━━━\n\n"
        "<b>МОДУЛИ ОТДЕЛЬНО</b>\n\n"
        "<code>"
        ...
        "Точную стоимость назову после разговора."
    ),
...
def kb_pay_start():
    return kb_inline([
        [{"text": "Через Т-Банк", "url": f"{SITE_URL}/pay"}],
...
def handle_callback(chat_id, data):
    ...
    if data == "menu:sol":
        ...
        return
    if data == "menu:price":
        send(chat_id, T["price_list"], reply_markup=kb_main(), parse_mode="HTML")
        return
    if data == "menu:works":
    ...
    if data == "pay:start":
        ...
        msg = "Оплата через Т-Банк или QR-код." + order_info
